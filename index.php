...
<body>
    ...
    <div class="info">
        <div class='info-text'>
            ...
            <p><br> Vierkante Wielen bestaat al 19 jaar. Wij geven les in een ontspannen en vakkundige manier.
    ...
    <div class="reviews">
        <div class="review-slide fade">
            <div class="review-img"><img src="Images/persoon1.png"></div>
        ...
        <div class="review-slide fade">
            <div class="review-img"><img src="Images/persoon2.png"></div>
            <div class="review-text">Super rijschool in Almere.
                Goeie instructeur die mij gelijk op mn gemak stelde en het gevoel gaf dat ik het kon.<br> Dankzij jullie dat ook in 1 x geslaagd !!</div>
            <div class="review-score">★★★★★</div>
        </div>
        <div class="review-slide fade">
            <div class="review-img"><img src="Images/persoon3.png"></div>
        ...
        <div class="review-slide fade">
            <div class="review-img"><img src="Images/persoon4.png"></div>
            <div class="review-text">Je krijgt de ruimte om je eigen rijlessen in te plannen.<br> Als je bijna gaat afrijden heb jij een streepje voor in de planning, <br> en als je voor de zekerheid een extra lesje wilt dan is dat zo geregeld. <br>
